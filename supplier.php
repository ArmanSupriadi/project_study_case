...
<body>
    ...
    <div class="col-md-12 mt-4">
                <h3>Data Supplier</h3>
                <a href="tambah_supplier.php" class="btn btn-primary bi bi-plus-square mb-2" style="margin-left: 96%;" ></a>
                    <table id="myTable" class="table table-striped" >
                        <thead>
                            <tr>
                                <td width="100px">ID Supplier</td>
                                <td width="100px">Nama Supplier</td>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-success bi bi-pencil-square btn-sm" href="edit_supplier.php?id_supplier=<?php echo $supplier['id_supplier'];?>"></a>
                                    <a class="btn btn-danger bi bi-x-square btn-sm " href="delete_supplier.php?id_supplier=<?php echo $supplier['id_supplier'];?>" ></a>
                                    </td>
                                </tr>
                            <?php }  ?>
                        </tbody>
