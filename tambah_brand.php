    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <h4>Tambah Brand</h4>
                <form action="proses_tambah_brand.php" method="post">
                <table class="table">
                    <tr>
                        <td>Kode Brand</td>
                        <td><input type="text" name="kd_brand" class="form-control" autocomplete="off"></td>
                    </tr>
                    <tr>
                    <tr>
                        <td>Nama Brand</td>
                        <td><input type="text" name="nama_brand"  class="form-control"></td>
                    </tr>
                    <tr>
                    <td>
