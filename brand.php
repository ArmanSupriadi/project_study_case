...
<body>
    ...
    <div class="col-md-12 mt-4">
                <h3>Data Brand</h3>
                <a href="tambah_brand.php" class="btn btn-primary bi bi-plus-square mb-2" style="margin-left: 96%;" ></a>
                    <table id="myTable" class="table table-striped" >
                        <thead>
                            <tr>
                                <td width="100px">Kode Brand</td>
                                <td width="100px">Nama Brand</td>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $brand["kd_brand"];?></td>
                                    <td><?php echo $brand["nama_brand"];?></td>

                                    <td>
                                    <a class="btn btn-success bi bi-pencil-square btn-sm" href="edit_brand.php?kd_brand=<?php echo $brand['kd_brand'];?>"></a>
                                    <a class="btn btn-danger bi bi-x-square btn-sm " href="delete_brand.php?kd_brand=<?php echo $brand['kd_brand'];?>" ></a>
                                    </td>
                                </tr>
                            <?php }  ?>
                        </tbody>
