                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="" method="post">
                                <input type="text" placeholder="What do yo u need?" class="cari" name="cari">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="price-range-wrap">
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"
                                    data-min="500.000" data-max="3.000.000">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    if (isset($_GET['cari'])) {
                        $cari = $_GET['cari'];
                        $barangg = mysqli_query($con, "SELECT * FROM barang WHERE nama_barang LIKE '%".$_GET['cari']."%' ");
                    } else {
                        $barangg = mysqli_query($con, "SELECT * FROM barang");
                    }
                    ...
                    {?>     
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/<?php echo $barang['gambar'];?>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="edit_barang.php?kd_barang=<?php echo $barang['kd_barang']; ?>"><i class="bi bi-pencil-square"></i></a></li>
                                        <li><a href="delete_barang.php?kd_barang=<?php echo $barang['kd_barang']; ?>" 
                                        onclick="return confirm('Apakah anda yakin ingin menghapusnya ?');"><i class="bi bi-trash3-fill"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>

                                <div class="product__item__text">
                                    <h6><a href="#"><?php echo $barang['nama_barang']; ?></a></h6>
